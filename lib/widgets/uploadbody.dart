...
class UploadBodyImages extends StatefulWidget {
  String textt;
  final OnIconPressed onPressedC;
  final OnIconPressed onPressedG;
  String imagepath;
  UploadBodyImages(
      {Key? key,
      required this.textt,
      required this.onPressedC,
      required this.onPressedG,
