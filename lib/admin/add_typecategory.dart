...
class AddCategoryHome extends StatefulWidget {
  const AddCategoryHome({super.key});

  @override
  State<AddCategoryHome> createState() => _AddCategoryHomeState();
}

Future AddCategoryhomeDetails(
  String CatImage,
) async {
...
class _AddCategoryHomeState extends State<AddCategoryHome> {
  var imageUrl;
  var downloadUrl;
  var imagee;
  var greyimage =
                  ...
                  Positioned(
                    ...
                    child: Container(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            uploadImage();
                            AddCategoryhomeDetails(greyimage).then((value) {
