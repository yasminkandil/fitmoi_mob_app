...
TextEditingController squantityyController = TextEditingController();
TextEditingController mquantityyController = TextEditingController();
TextEditingController lquantityyController = TextEditingController();
TextEditingController xlquantityyController = TextEditingController();
TextEditingController xxlquantityyController = TextEditingController();
TextEditingController qualityyController = TextEditingController();
TextEditingController categoryyController = TextEditingController();

class EditProd extends StatefulWidget {
  final String prodd;
  EditProd({required this.prodd});
    ...
    return Scaffold(
      ...
      body: Container(
        child: FutureBuilder<DocumentSnapshot>(
          future: products.doc(widget.prodd).get(),
